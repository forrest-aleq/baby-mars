...
async def run_scenario(scenario_name: str, verbose: bool = True) -> dict:
...
async def run_scenario_streaming(scenario_name: str, verbose: bool = True) -> dict:
...
def print_result(result: dict):
    ...
    if result.get("gate_violation_detected"):
        ...
        if result.get("gate_fallback_used"):
            print("    → Used fallback boundary response")
