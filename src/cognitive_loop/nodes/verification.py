...
from ...claude_client import get_claude_client, ValidationOutput
    ...
    def amount_validator(
        ...
        if amount > max_val:
            return {
                ...
                "fix_hint": f"Amount exceeds limit - requires additional approval"
            }
...
async def _claude_validation(
    ...
    if beliefs:
        ...
        context_parts.append(f"<relevant_beliefs>\n" + "\n".join(belief_strs) + "\n</relevant_beliefs>")
